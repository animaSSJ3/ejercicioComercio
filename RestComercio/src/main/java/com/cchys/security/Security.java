...
public class Security {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(requests -> requests
				.requestMatchers("/api/v1/obtieneToken", "/api/v1/obtiene-productos", "/api/v1/obtiene-producto",
						"/api/v1/guardar-producto", "/api/v1/elimina-producto")
		...
		http.csrf(csrf -> csrf.csrfTokenRequestHandler(new SpaCsrfTokenRequestHandler())
				...
				.ignoringRequestMatchers("/api/v1/obtieneToken", "/api/v1/obtiene-productos",
						"/api/v1/obtiene-producto", "/api/v1/guardar-producto", "/api/v1/elimina-producto")
